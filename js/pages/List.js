        ...
        <main v-else class="page-list">
            ...
            <div class="level-container surface">
                <div class="level" v-if="level">
                    ...
                    <p v-else-if="selected +1 <= 50
                    "><strong>100%</strong> or better to qualify</p>
            ...
            <div class="meta-container surface">
                <div class="meta">
                    ...
                    <p>
                        Public LDM's are allowed if one is not present on the actual level
                    </p>
                    <p>
                        Once a level falls onto the Legacy List, we will no longer accept records for said level
                    </p>
                </div>
            </div>
        </main>
